...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#000000] text-[#FFFFFF] font-montserrat selection:bg-[#e3a638] selection:text-black pb-20">
      
      {/* Hero Section */}
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        {/* Background Image / Gradient */}
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/50 to-[#000000] z-10"></div>
        ...
        <div className="relative z-20 text-center px-6 max-w-4xl mx-auto flex flex-col items-center">
          <h2 className="text-[#e3a638] text-sm md:text-base tracking-[0.3em] uppercase mb-4 font-montserrat">
            Trung tâm tổ chức Sự kiện, Tiệc cưới & Nhà hàng
          </h2>
          <h1 className="text-5xl md:text-7xl font-semibold mb-6 leading-tight drop-shadow-2xl font-playfair">
            Golden Palace<br/>
            <span className="italic font-light text-4xl md:text-6xl text-[#e3a638]">
              Nơi khởi đầu hạnh phúc trọn vẹn
            </span>
          </h1>
          <p className="text-gray-300 mb-10 text-lg md:text-xl font-montserrat font-light max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link href="/du-toan-chi-phi" className="px-8 py-4 bg-gradient-to-r from-[#e3a638] to-[#a66a3a] text-black font-semibold rounded-none hover:shadow-[0_0_20px_rgba(227,166,56,0.4)] transition-all uppercase tracking-wider font-montserrat text-sm">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto relative z-10 border-b border-[#e3a638]/20">
        <div className="text-center mb-16">
          <h3 className="text-[#e3a638] font-montserrat uppercase tracking-[0.2em] text-sm mb-2">Giá trị cốt lõi</h3>
          <h2 className="text-4xl md:text-5xl font-playfair">Cam kết của chúng tôi</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="text-center group">
            <div className="w-20 h-20 mx-auto mb-6 flex items-center justify-center rounded-full bg-[#e3a638]/10 group-hover:bg-[#e3a638]/20 transition-colors">
              <span className="material-symbols-outlined text-4xl text-[#e3a638]">verified_user</span>
            </div>
            <h4 className="text-2xl font-playfair text-[#e3a638] mb-4">Sự An Tâm</h4>
            <p className="text-gray-300 font-montserrat text-sm font-light leading-relaxed">
          ...
          <div className="text-center group">
            <div className="w-20 h-20 mx-auto mb-6 flex items-center justify-center rounded-full bg-[#e3a638]/10 group-hover:bg-[#e3a638]/20 transition-colors">
              <span className="material-symbols-outlined text-4xl text-[#e3a638]">diamond</span>
            </div>
            <h4 className="text-2xl font-playfair text-[#e3a638] mb-4">Sự Chỉn Chu & Thể Diện</h4>
            <p className="text-gray-300 font-montserrat text-sm font-light leading-relaxed">
          ...
          <div className="text-center group">
            <div className="w-20 h-20 mx-auto mb-6 flex items-center justify-center rounded-full bg-[#e3a638]/10 group-hover:bg-[#e3a638]/20 transition-colors">
              <span className="material-symbols-outlined text-4xl text-[#e3a638]">handshake</span>
            </div>
            <h4 className="text-2xl font-playfair text-[#e3a638] mb-4">Minh Bạch Giá Trị Thực</h4>
            <p className="text-gray-300 font-montserrat text-sm font-light leading-relaxed">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <h3 className="text-[#e3a638] font-montserrat uppercase tracking-[0.2em] text-sm mb-2">Dịch vụ</h3>
          <h2 className="text-4xl md:text-5xl font-playfair">Dấu ấn khó phai</h2>
          <div className="w-16 h-[1px] bg-[#e3a638] mx-auto mt-6"></div>
        </div>
      ...
      <section className="py-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-[#e3a638]/5 z-0"></div>
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="bg-[#111] border border-[#e3a638]/20 p-10 md:p-16 rounded-sm flex flex-col md:flex-row items-center justify-between gap-10 shadow-2xl relative overflow-hidden">
            <div className="absolute -top-40 -right-40 w-80 h-80 bg-[#e3a638]/10 rounded-full blur-3xl"></div>
            
            <div className="flex-1">
              <h3 className="text-3xl font-semibold mb-4 text-white font-playfair">Bạn đang lên kế hoạch cho sự kiện?</h3>
              <p className="text-gray-400 font-montserrat font-light mb-6 max-w-xl">
              ...
              <ul className="space-y-3 font-montserrat text-sm text-gray-300 font-light mb-8">
                ...
                <li className="flex items-center gap-3">
                  <span className="w-1.5 h-1.5 bg-[#e3a638] rounded-full"></span>
                  Liên hệ Hotline <strong className="text-[#e3a638] ml-1">0228 659 5959</strong>
                </li>
              </ul>
            </div>
            
            <div className="w-full md:w-auto">
              <Link href="/du-toan-chi-phi" className="block w-full text-center px-10 py-5 bg-gradient-to-r from-[#e3a638] to-[#a66a3a] text-black font-semibold hover:opacity-90 transition-opacity uppercase tracking-wider font-montserrat text-sm shadow-[0_0_30px_rgba(227,166,56,0.3)]">
