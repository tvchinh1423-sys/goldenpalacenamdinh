...
export default function VenueGalleryClient({ gallery = [], venueName = '' }) {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {gallery.map((imgUrl, gIdx) => (
          <div 
            ...
            className="group relative h-72 rounded-xl overflow-hidden shadow-lg border border-[#e3a638]/20 cursor-pointer"
          >
            <div 
