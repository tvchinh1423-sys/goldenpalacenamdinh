import './globals.css';
import { Montserrat, Playfair_Display, Great_Vibes, Lora } from 'next/font/google';
...
export default function RootLayout({ children }) {
  return (
    <html lang="vi" className={`${montserrat.variable} ${playfair.variable} ${greatVibes.variable} ${lora.variable}`}>
      <head>
        <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&display=swap" rel="stylesheet" />
        <link href="https://fonts.googleapis.com/css2?family=Ballet:opsz@16..72&family=Cinzel+Decorative:wght@700;900&family=Bodoni+Moda:ital,opsz,wght@0,6..96,700;1,6..96,400&family=Cormorant+Garamond:ital,wght@0,600;1,400&family=Great+Vibes&display=swap" rel="stylesheet" />
