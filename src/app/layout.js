import './globals.css';
import { Montserrat, Playfair_Display, Great_Vibes, Lora, Cormorant_Garamond } from 'next/font/google';
...
export default function RootLayout({ children }) {
  return (
    <html lang="vi" className={`${montserrat.variable} ${playfair.variable} ${greatVibes.variable} ${lora.variable} ${cormorant.variable}`}>
      <head>
